      ...
      <Media greaterThan="mobile">
        ...
        >
          <Segment
            ...
            vertical
            style={{ backgroundColor: "rgba(6,6,6,.5)" }}
          >
            <Menu
      ...
      <Grid container stackable verticalAlign="middle">
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <Header
              as="h3"
              style={{ fontSize: "2em", backgroundColor: "white" }}
            >
              Some Food for Thought
            </Header>
            <p style={{ fontSize: "1.33em", backgroundColor: "white" }}>
              The United States discards 80 billion pounds of ediable food every
              year, While 35 million people across America has food insecurity.
              That number is expected to rise to as much as 50 million in 2021.
              Wasting food contributes to 11 percent of the world's greenhouse
              gas emissions.
            </p>
            <Header
              as="h3"
            ...
            <p style={{ fontSize: "1.33em", backgroundColor: "white" }}>
              12.8 percent of New Yorkers are food insecure. The Natural
              Resources Defense Council (NRDC) found that 68 percent of all
              discarded food was considered still edible. 54 percent of food
              waste was generated in residential settings, while 20 percent were
              generated by restaurants and caterers.
            </p>
          </Grid.Column>
          <Grid.Column floated="right" width={6}>
            <Image bordered rounded size="medium" src={leftoversjpg} />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
